...
public class SimonDiceMenu {
    ...
    public static void open(Player player) {
        ...
        menuBuilder.setContents(player, () -> {
            ...
            menuBuilder.setItem(player, slot(2, 2), new ItemBuilder(Material.ENDER_PEARL, "&aTeletransportar").build(), () ->{
                SimonDiceActions.teleport(player);
            });
            ...
            menuBuilder.setItem(player, slot(5, 2), new ItemBuilder(Material.PAPER, "&aTeletransportar").build(), () ->{
